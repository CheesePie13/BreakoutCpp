...
g++ -o bin/mac-release/BreakoutCppMac_$version.app src/*.cpp src/*.c -DMACOS -DVERSION=\"$version\" -Iinclude -Llib-mac -lglfw3 -framework Cocoa -framework OpenGL -framework IOKit -Wall -O2
